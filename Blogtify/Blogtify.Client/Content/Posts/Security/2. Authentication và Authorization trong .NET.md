...
$attribute: PostMetadata(Id = 2, Title = "Authentication và Authorization trong .NET", Category = "Bảo mật", LastModified = "19-10-2025")
...
<div class="mermaid"> 
flowchart LR
    A[Hành khách đến sân bay] --> B[Xác thực danh tính - kiểm tra CCCD/hộ chiếu và vé]
